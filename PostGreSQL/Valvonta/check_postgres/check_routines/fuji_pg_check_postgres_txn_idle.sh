...
##
##      -----------------------------------------------------------------------
##      $RCSfile: fuji_pg_check_postgres_txn_idle.sh,v $
##      $Revision: 1.0 $
##
##      /**** FOR LINUX ****/
##
...
##
##      $Log: fuji_pg_check_postgres_txn_idle.sh,v $
##
...
#
#
# Sijainti: /home/fujitsu/bin/check_postgres/fuji_pg_check_postgres_txn_idle.sh

# Load common definitions
. /home/fujitsu/conf/fuji_check_postgres_common.sh

$CHECK_POSTGRES_DIR/check_postgres_txn_idle  --warning=$TXN_IDLE_WARNING --critical=$TXN_IDLE_CRITICAL | \
