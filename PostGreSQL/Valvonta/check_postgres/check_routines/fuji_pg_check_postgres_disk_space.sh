...
##
##      -----------------------------------------------------------------------
##      $RCSfile: fuji_pg_check_postgres_disk_space.sh,v $
##      $Revision: 1.0 $
##
##      /**** FOR LINUX ****/
##
...
##
##      $Log: fuji_pg_check_postgres_disk_space.sh,v $
##
...
#
#
# Sijainti: /home/fujitsu/bin/check_postgres/fuji_pg_check_postgres_disk_space.sh

# Load common definitions
. /home/fujitsu/conf/fuji_check_postgres_common.sh

$CHECK_POSTGRES_DIR/check_postgres_disk_space  --warning=$DISK_SPACE_WARNING --critical=$DISK_SPACE_CRITICAL | \
