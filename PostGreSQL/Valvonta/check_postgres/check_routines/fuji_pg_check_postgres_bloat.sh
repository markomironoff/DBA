...
##
##      -----------------------------------------------------------------------
##      $RCSfile: fuji_pg_check_postgres_bloat.sh,v $
##      $Revision: 1.1 $
##
##      /**** FOR LINUX ****/
##
...
##
##      $Log: fuji_pg_check_postgres_bloat.sh,v $
##
...
#
#
# Sijainti: /home/fujitsu/bin/check_postgres/fuji_pg_check_postgres_bloat.sh
...
for db in $DBS
do
$CHECK_POSTGRES_DIR/check_postgres_bloat  --warning="$BLOAT_WARNING" --critical="$BLOAT_CRITICAL" --dbname=$db --perflimit=1 | \
