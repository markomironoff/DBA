...
##
##      -----------------------------------------------------------------------
##      $RCSfile: fuji_pg_check_postgres_archive_ready.sh,v $
##      $Revision: 1.0 $
##
##      /**** FOR LINUX ****/
##
##      Contents: check_postgres rutiini
##
##      $Author: rosenjyr $
##      $Date: 2015/09/17 14:10:03 $
##
##      $Log: fuji_pg_check_postgres_archive_ready.sh,v $
##
...
#
#
# Sijainti: /home/fujitsu/bin/check_postgres/fuji_pg_check_postgres_archive_ready.sh

# Load common definitions
. /home/fujitsu/conf/fuji_check_postgres_common.sh

$CHECK_POSTGRES_DIR/check_postgres_archive_ready  --warning=$ARCHIVE_READY_WARNING --critical=$ARCHIVE_READY_CRITICAL | \
