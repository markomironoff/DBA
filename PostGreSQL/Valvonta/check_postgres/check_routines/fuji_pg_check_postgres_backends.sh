...
##
##      -----------------------------------------------------------------------
##      $RCSfile: fuji_pg_check_postgres_backends.sh,v $
##      $Revision: 1.0 $
##
##      /**** FOR LINUX ****/
##
...
##
##      $Log: fuji_pg_check_postgres_backends.sh,v $
##
...
#
#
# Sijainti: //home/fujitsu/bin/check_postgres/fuji_pg_check_postgres_backends.sh

# Load common definitions
. /home/fujitsu/conf/fuji_check_postgres_common.sh

$CHECK_POSTGRES_DIR/check_postgres_backends  --warning=$BACKENDS_WARNING --critical=$BACKENDS_CRITICAL | \
