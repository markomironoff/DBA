...
##
##      -----------------------------------------------------------------------
##      $RCSfile: fuji_pg_check_postgres_txn_wraparound.sh,v $
##      $Revision: 1.1 $
##
##      /**** FOR LINUX ****/
##
...
##
##      $Log: fuji_pg_check_postgres_txn_wraparound.sh,v $
##
...
#
#
# Sijainti: /home/fujitsu/bin/check_postgres/fuji_pg_check_postgres_txn_wraparound.sh
...
if [ -z $TXN_WRAPAROUND_WARNING ]
then
  TXN_WRAPAROUND_WARNING="1_300_000_000"
fi
if [ -z $TXN_WRAPAROUND_CRITICAL ]
then
  TXN_WRAPAROUND_CRITICAL="1_700_000_000"
fi
$CHECK_POSTGRES_DIR/check_postgres_txn_wraparound  --warning=$TXN_WRAPAROUND_WARNING --critical=$TXN_WRAPAROUND_CRITICAL | \
