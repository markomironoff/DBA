...
##
##      -----------------------------------------------------------------------
##      $RCSfile: fuji_pg_check_postgres_query_runtime.sh,v $
##      $Revision: 1.0 $
##
##      /**** FOR LINUX ****/
##
...
##
##      $Log: fuji_pg_check_postgres_query_runtime.sh,v $
##
...
#
#
# Sijainti: /home/fujitsu/bin/check_postgres/fuji_pg_check_postgres_query_runtime.sh

# Load common definitions
. /home/fujitsu/conf/fuji_check_postgres_common.sh

$CHECK_POSTGRES_DIR/check_postgres_query_runtime  --warning=$QUERY_RUNTIME_WARNING --critical=$QUERY_RUNTIME_CRITICAL \
--queryname=$QUERY_RUNTIME_QUERYNAME --dbname=$QUERY_RUNTIME_DBNAME| \
